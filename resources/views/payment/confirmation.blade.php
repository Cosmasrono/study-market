...
<body class="bg-gray-50">
    ...
    <script>
        ...
        function checkPaymentStatus() {
            ...
            fetch(`/membership/payment-status/${reference}`)
        ...
        function showTimeoutMessage() {
            document.getElementById('payment-status').innerHTML = `
                <div class="flex items-center justify-center p-4 bg-orange-50 border border-orange-200 rounded-lg">
                    <span class="text-orange-700 font-medium">Check timed out. Click "Check Status" to verify payment.</span>
                </div>
            `;
        }
        ...
        window.addEventListener('load', function() {
            setTimeout(startAutoStatusCheck, 5000);
        });
